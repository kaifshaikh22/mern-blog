...
export default function PostPage() {
    ...
    if (loading) return (
     ...
     return <main className="p-3 flex flex-col max-w-6xl mx-auto min-h-screen">
        <h1 className=" text-3xl mt-10 p-3 text-center font-serifmax-w-2xl
        max-auto lg:text-4xl">{post && post.title}</h1>
        ...
        mx-auto w-full max-w-2xl text-xs">
            ...
            <span className="italic">{post && (post.content.length /2000).toFixed(0)} mins read</span>
         </div>
